...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private toastCtrl:ToastController ,private menuCtrl: MenuController, private homeMessage: MessageToHomeProvider) {
